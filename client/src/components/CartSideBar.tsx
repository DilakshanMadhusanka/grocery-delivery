...
const CartSideBar = () => {
  ...
  const deliveryFee = cartTotal > 6000 ? 0 : 600;
          ...
          <div className="p-5 border-t border-app-border space-y-3">
            ...
            {deliveryFee > 0 && (
              <p className="text-xs text-app-text-light text-center">
                Free delivery on orders over {currency} 6000!
              </p>
            )}

            <div className="flex justify-between text-base font-semibold bordr-t border-app-border pt-3">
              <span>Total</span>
              <span>
                {currency}
