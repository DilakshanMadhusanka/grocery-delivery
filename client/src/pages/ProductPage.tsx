          ...
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="relative flex-center p-8 md:p-12 min-h-[320px] md:min-h-[480px]">
              ...
              <div className="absolute top-5 left-5 flex flex-wrap gap-1.5">
                {product.isOrganic && (
                  <span className="flex items-center gap-1 bg-app-green text-white text-xs font-semibold px-2.5 py-1 rounded-full">
                ...
                {product.discount > 0 && (
                  <span className="bg-app-orange text-white text-xs font-semibold px-2.5 py-1 rounded-full">
            ...
            <div className="p-6 md:p-10 flex flex-col justify-center">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center border border-app-border rounded-xl overflow-hidden">
                  ...
                  <span className="px-4 py-3 text-sm font-medium text-app-green">
                    {displayQuantity}
                  </span>
        ...
        {relatedProducts.length > 0 && (
          <section className="mt-12 mb-44">
            <div className="flex items-center justify-between mb-6">
              ...
              <Link
                to={`/products?category=${product.category}`}
                className="text-sm font-semibold flex items-center gap-1 text-app-orange font-medium hover:text-app-orangr-dark transition-colors"
              >
